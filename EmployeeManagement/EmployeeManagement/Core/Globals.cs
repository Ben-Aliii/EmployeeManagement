namespace EmployeeManagement
{
    ...
    {
        public const string EmployeeLoginUrl = "http://localhost/employeemanagement/employee/employee_login.php";
        public const string EmployeeCreateUrl = "http://localhost/employeemanagement/employee/employee_create.php";
